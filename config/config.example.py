...
ANTHROPIC_API_KEY = os.getenv("ANTHROPIC_API_KEY", "paste-your-claude-key-here")
OPENAI_API_KEY    = os.getenv("OPENAI_API_KEY",    "paste-your-openai-key-here")
GEMINI_API_KEY    = os.getenv("GEMINI_API_KEY",    "paste-your-gemini-key-here")
